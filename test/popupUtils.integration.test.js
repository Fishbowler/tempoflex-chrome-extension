...
describe('getFlex', ()=>{
    ...
    it('will calculate flex when balanced at the end of a working day', async ()=>{
        ...
        nock(testFixtures.settings.default.jiraBaseUrl)
            .post(testFixtures.worklogSearchUrl, {worker: [testFixtures.settings.default.username], from:'2019-01-04', to:'2019-02-02'})
            .reply(200, [])
        const flex = await popupUtils.getFlex()
    ...
    it('will calculate flex when a user started after 1st Jan', async ()=>{
        ...
        nock(testFixtures.settings.default.jiraBaseUrl)
            ...
            .reply(200, [])
        nock(testFixtures.settings.default.jiraBaseUrl)
            .post(testFixtures.worklogSearchUrl, {worker: [testFixtures.settings.default.username], from:'2019-01-05', to:'2019-02-03'})
            .reply(200, [])
        nock(testFixtures.settings.default.jiraBaseUrl)
